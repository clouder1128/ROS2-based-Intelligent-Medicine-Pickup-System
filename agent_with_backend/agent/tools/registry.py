    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "pregnant": {"type": "string", "description": "怀孕/哺乳状态，如'否'、'是(孕20周)'、'哺乳期'"},
                "drug_allergies": {"type": "string", "description": "药物过敏史，如'布洛芬、青霉素'"},
                "food_allergies": {"type": "string", "description": "食物/辅料过敏史，如'鱼肉'"},
                "medical_history": {"type": "string", "description": "病史摘要，如'胃溃疡、高血压'"},
                "vital_signs": {"type": "string", "description": "生命体征摘要，如'体温:38.5℃'"},
            },
