...
def test_create_approval_success(client):
    ...
    response = client.post(
        "/api/approvals", data=json.dumps(data), content_type="application/json"
    )
...
def test_get_approval_success(client):
    ...
    create_data = {"patient_name": "Test Patient", "advice": "Test advice"}
    create_response = client.post(
        "/api/approvals", data=json.dumps(create_data), content_type="application/json"
    )
...
def test_create_approval_invalid_json(client):
    ...
    response = client.post("/api/approvals", data="", content_type="application/json")
    ...
    response = client.post(
        "/api/approvals", data="{invalid json", content_type="application/json"
    )
...
def test_get_pending_approvals(client):
    ...
    create_data = {"patient_name": "Pending Test", "advice": "Pending advice"}
    client.post(
        "/api/approvals", data=json.dumps(create_data), content_type="application/json"
    )
...
def test_approve_approval(client):
    ...
    # Create a pending approval
    create_data = {"patient_name": "Approve Test", "advice": "Approve this"}
    create_response = client.post(
        "/api/approvals", data=json.dumps(create_data), content_type="application/json"
    )
    create_result = json.loads(create_response.data)
    ...
    # Approve it
    approve_data = {"doctor_id": "dr_smith", "notes": "Approved with dosage adjustment"}
    response = client.post(
...
def test_reject_approval(client):
    ...
    # Create a pending approval
    create_data = {"patient_name": "Reject Test", "advice": "Reject this"}
    create_response = client.post(
        "/api/approvals", data=json.dumps(create_data), content_type="application/json"
    )
    create_result = json.loads(create_response.data)
    ...
    # Reject it
    reject_data = {"doctor_id": "dr_jones", "reason": "Patient has contraindication"}
    response = client.post(
