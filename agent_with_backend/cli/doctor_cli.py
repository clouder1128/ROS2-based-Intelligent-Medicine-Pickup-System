...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] in ["-h", "--help", "help"]:
        print("用法:")
        print("  1. 交互式模式: python doctor_cli.py")
        print("  2. 直接批准: python doctor_cli.py AP-20260408-ABCD1234")
        print(
            "  3. 带医生建议的直接批准: python doctor_cli.py AP-20260408-ABCD1234 --notes '医生建议内容'"
        )
        print("\n示例:")
        print("  python doctor_cli.py")
        print("  python doctor_cli.py AP-20260408-ABCD1234")
        print(
            "  python doctor_cli.py AP-20260408-ABCD1234 --doctor-id 'doctor_001' --notes '饭后服用'"
        )
        sys.exit(0)
