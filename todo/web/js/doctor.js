...
class DoctorApp {
    ...
    async loadApprovals() {
        ...
        try {
            // 调用API获取待审批列表
            const data = await window.App.APIService.getPendingApprovals(this.doctorId);
            ...
            this.renderApprovalList(mockData);
            this.updateStats(mockData.length);
