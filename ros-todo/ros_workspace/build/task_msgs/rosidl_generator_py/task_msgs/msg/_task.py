...
class Metaclass_Task(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from task_msgs.msg import CabinetOrder
            if CabinetOrder.__class__._TYPE_SUPPORT is None:
                CabinetOrder.__class__.__import_type_support__()
...
class Task(metaclass=Metaclass_Task):
    ...
    _fields_and_field_types = {
        'task_id': 'string',
        'cabinets': 'sequence<task_msgs/CabinetOrder>',
        'type': 'string',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['task_msgs', 'msg'], 'CabinetOrder')),  # noqa: E501
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.cabinets = kwargs.get('cabinets', [])
    ...
    def __eq__(self, other):
        ...
        if self.task_id != other.task_id:
            return False
        if self.cabinets != other.cabinets:
            return False
    ...
    @builtins.property
    def cabinets(self):
        """Message field 'cabinets'."""
        return self._cabinets

    @cabinets.setter
    def cabinets(self, value):
        if self._check_fields:
            from task_msgs.msg import CabinetOrder
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, CabinetOrder) for v in value) and
                 True), \
                "The 'cabinets' field must be a set or sequence and each value of type 'CabinetOrder'"
