...
#ifndef TASK_MSGS__MSG__DETAIL__TASK_STATE__FUNCTIONS_H_
#define TASK_MSGS__MSG__DETAIL__TASK_STATE__FUNCTIONS_H_
 ...
 * )) before or use
 * task_msgs__msg__TaskState__create()
 ...
 * calls
 * task_msgs__msg__TaskState__init().
...
/**
 * It calls
 * task_msgs__msg__TaskState__fini()
 ...
 * task_msgs__msg__TaskState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * task_msgs__msg__TaskState__Sequence__fini()
 * on the array,
...
#endif  // TASK_MSGS__MSG__DETAIL__TASK_STATE__FUNCTIONS_H_
