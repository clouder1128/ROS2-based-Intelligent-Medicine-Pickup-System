...
{
bool cdr_serialize(
  const task_msgs::msg::CabinetOrder &,
  ...
  task_msgs::msg::Task & ros_message)
{
  ...
  // Member: cabinets
  {
    ...
    ros_message.cabinets.resize(size);
    for (size_t i = 0; i < size; i++) {
      task_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.cabinets[i]);
    }
  }
  ...
  // Member: cabinets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.cabinets[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: cabinets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CabinetOrder(
  ...
  size_t current_alignment)
{
  ...
  // Member: cabinets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CabinetOrder(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
