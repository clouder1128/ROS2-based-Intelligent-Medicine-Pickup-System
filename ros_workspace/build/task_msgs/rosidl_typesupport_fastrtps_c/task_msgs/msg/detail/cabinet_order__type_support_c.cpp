...
#include "task_msgs/msg/detail/cabinet_order__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // cabinet_id
#include "rosidl_runtime_c/string_functions.h"  // cabinet_id
...
using _CabinetOrder__ros_msg_type = task_msgs__msg__CabinetOrder;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
bool cdr_serialize_task_msgs__msg__CabinetOrder(
  const task_msgs__msg__CabinetOrder * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: cabinet_id
  {
    const rosidl_runtime_c__String * str = &ros_message->cabinet_id;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
bool cdr_deserialize_task_msgs__msg__CabinetOrder(
  eprosima::fastcdr::Cdr & cdr,
  task_msgs__msg__CabinetOrder * ros_message)
{
  // Field name: cabinet_id
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->cabinet_id.data) {
      rosidl_runtime_c__String__init(&ros_message->cabinet_id);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->cabinet_id,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'cabinet_id'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
size_t get_serialized_size_task_msgs__msg__CabinetOrder(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CabinetOrder__ros_msg_type * ros_message = static_cast<const _CabinetOrder__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
size_t max_serialized_size_task_msgs__msg__CabinetOrder(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_msgs__msg__CabinetOrder;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
bool cdr_serialize_key_task_msgs__msg__CabinetOrder(
  const task_msgs__msg__CabinetOrder * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: cabinet_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
size_t get_serialized_size_key_task_msgs__msg__CabinetOrder(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CabinetOrder__ros_msg_type * ros_message = static_cast<const _CabinetOrder__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_msgs
size_t max_serialized_size_key_task_msgs__msg__CabinetOrder(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const task_msgs__msg__CabinetOrder * ros_message = static_cast<const task_msgs__msg__CabinetOrder *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_task_msgs__msg__CabinetOrder(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  task_msgs__msg__CabinetOrder * ros_message = static_cast<task_msgs__msg__CabinetOrder *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_task_msgs__msg__CabinetOrder(cdr, ros_message);
}

static uint32_t _CabinetOrder__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_task_msgs__msg__CabinetOrder(
...
static size_t _CabinetOrder__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_task_msgs__msg__CabinetOrder(
...
static message_type_support_callbacks_t __callbacks_CabinetOrder = {
  "task_msgs::msg",
  "CabinetOrder",
...
static rosidl_message_type_support_t _CabinetOrder__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CabinetOrder,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, task_msgs, msg, CabinetOrder)() {
  return &_CabinetOrder__type_support;
}
