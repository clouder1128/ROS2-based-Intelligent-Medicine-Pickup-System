...
#include "task_msgs/msg/detail/cabinet_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task_msgs::msg::CabinetState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task_msgs::msg::CabinetState & ros_message)
{
  // Member: cabinet_id
  cdr >> ros_message.cabinet_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task_msgs
max_serialized_size_CabinetState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_msgs::msg::CabinetState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task_msgs
max_serialized_size_key_CabinetState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const task_msgs::msg::CabinetState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task_msgs::msg::CabinetState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CabinetState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const task_msgs::msg::CabinetState *>(
...
static size_t _CabinetState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CabinetState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CabinetState__callbacks = {
  "task_msgs::msg",
  "CabinetState",
...
static rosidl_message_type_support_t _CabinetState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CabinetState__callbacks,
...
{
  return &task_msgs::msg::typesupport_fastrtps_cpp::_CabinetState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_msgs, msg, CabinetState)() {
  return &task_msgs::msg::typesupport_fastrtps_cpp::_CabinetState__handle;
}
