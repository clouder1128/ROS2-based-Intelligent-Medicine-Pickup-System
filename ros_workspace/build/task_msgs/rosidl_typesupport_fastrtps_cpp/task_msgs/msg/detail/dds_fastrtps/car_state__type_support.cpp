...
#include "task_msgs/msg/detail/car_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task_msgs::msg::CarState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task_msgs::msg::CarState & ros_message)
{
  // Member: car_id
  cdr >> ros_message.car_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_msgs::msg::CarState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task_msgs
max_serialized_size_key_CarState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const task_msgs::msg::CarState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task_msgs::msg::CarState *>(
    untyped_ros_message);
...
{
  return &task_msgs::msg::typesupport_fastrtps_cpp::_CarState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_msgs, msg, CarState)() {
  return &task_msgs::msg::typesupport_fastrtps_cpp::_CarState__handle;
}
